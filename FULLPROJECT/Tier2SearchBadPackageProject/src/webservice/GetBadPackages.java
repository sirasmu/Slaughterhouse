...
/**
 *  GetBadPackages bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetBadPackages implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getBadPackages", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getBadPackages", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetBadPackages parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetBadPackages object = new GetBadPackages();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getBadPackages".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetBadPackages) webservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
