...
/**
 *  ContactTier2 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ContactTier2 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":contactTier2", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "contactTier2", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ContactTier2 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ContactTier2 object = new ContactTier2();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"contactTier2".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ContactTier2) tier2.webservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
